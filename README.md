...
**Melodic patterns** — Uses Markov chains to generate progressions that fit musical melodies. Covers most of the cells you'll ever run into. Has three sub-sections:
- One generates a chord progression, then lets you generate random melodies over it.
- One generates a melody and lets you reharmonize it.
- One lets you practice patterns over changes.
